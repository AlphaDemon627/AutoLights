 ...
 */
@Entity
@Table(name = "thursday", catalog = "autolightsdb2", schema = "")
@NamedQueries({
    @NamedQuery(name = "Thursday.findAll", query = "SELECT t FROM Thursday t"),
    @NamedQuery(name = "Thursday.findByEntryId", query = "SELECT t FROM Thursday t WHERE t.entryId = :entryId"),
    @NamedQuery(name = "Thursday.findByMovementId", query = "SELECT t FROM Thursday t WHERE t.movementId = :movementId"),
    @NamedQuery(name = "Thursday.findByTimeId", query = "SELECT t FROM Thursday t WHERE t.timeId = :timeId"),
    @NamedQuery(name = "Thursday.findByDay", query = "SELECT t FROM Thursday t WHERE t.day = :day"),
    @NamedQuery(name = "Thursday.findByDate", query = "SELECT t FROM Thursday t WHERE t.date = :date"),
    @NamedQuery(name = "Thursday.findByLgvCount", query = "SELECT t FROM Thursday t WHERE t.lgvCount = :lgvCount"),
    @NamedQuery(name = "Thursday.findByHgvCount", query = "SELECT t FROM Thursday t WHERE t.hgvCount = :hgvCount"),
    @NamedQuery(name = "Thursday.findByTotalVehCount", query = "SELECT t FROM Thursday t WHERE t.totalVehCount = :totalVehCount")})
public class Thursday implements Serializable {
    ...
    public Thursday(Integer entryId) {
    ...
    public String toString() {
        return "AutoLightsUI.Thursday[ entryId=" + entryId + " ]";
    }
